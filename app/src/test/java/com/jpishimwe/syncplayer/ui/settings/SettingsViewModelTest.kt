...
class SettingsViewModelTest {
    ...
    @Test
    fun `initial state is signed out with idle sync status`() = runTest {
    ...
    @Test
    fun `no previous sync — lastSyncTime is null`() = runTest {
    ...
    @Test
    fun `auth state change to signed in is reflected in uiState`() = runTest {
        viewModel.uiState.test {
    ...
    @Test
    fun `auth sign out is reflected in uiState`() = runTest {
    ...
    @Test
    fun `sync status Syncing is reflected in uiState`() = runTest {
        viewModel.uiState.test {
            awaitItem() // initial
    ...
    @Test
    fun `sync status Success exposes syncedAt as lastSyncTime`() = runTest {
    ...
    @Test
    fun `sync status Error is reflected in uiState`() = runTest {
        viewModel.uiState.test {
            awaitItem() // initial
    ...
    @Test
    fun `SignInWithToken event calls authRepository signInWithToken`() = runTest {
    ...
    @Test
    fun `SyncNow event triggers syncOrchestrator sync`() = runTest {
